...
assert.equal(report.rows.some((row) => row.platform === 'google_meet' && row.action === 'adapter_routes'), true);
assert.equal(report.rows.some((row) => row.platform === 'google_meet' && row.action === 'adapter_blueprints'), true);
assert.equal(report.rows.some((row) => row.platform === 'google_meet' && row.action === 'run_manifest'), true);
assert.equal(report.rows.some((row) => row.platform === 'zoom' && row.action === 'run_handoff_readiness'), true);
...
assert.equal(writtenReport.rows.length, 54);
...
assert.match(textStdout, /webex: action=adapter_routes/);
assert.match(textStdout, /webex: action=adapter_blueprints/);
assert.match(textStdout, /webex: action=run_manifest/);
