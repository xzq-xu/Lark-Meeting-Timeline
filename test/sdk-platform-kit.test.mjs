...
assert.equal(googleKitReport.platform_adapter_runtime_recipe_matrix.platform_count, 1);
assert.equal(googleKitReport.platform_adapter_runtime_recipe_matrix.runtime_ready_count, 1);
...
assert.equal(extensionPlan.content_script_adapter, '@ai-annotation/meeting-timeline-sdk/adapters/meeting-app-local-content-runtime');
assert.equal(extensionPlan.local_content_runtime_adapter, '@ai-annotation/meeting-timeline-sdk/adapters/meeting-app-local-content-runtime');
...
assert.equal(report.platform_provider_replay_matrix.accepted_count, 5);
assert.equal(report.platform_realtime_axis_readiness_matrix.provider_replay_accepted_count, 5);
assert.equal(report.platform_realtime_axis_readiness_matrix.waiting_for_live_evidence_count, 5);
