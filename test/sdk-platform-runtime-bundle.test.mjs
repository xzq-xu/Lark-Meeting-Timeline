...
assert.equal(google.messaging.bridge_message_types.includes('meeting_timeline.candidate_launch_plan'), true);
assert.equal(google.messaging.bridge_message_types.includes('meeting_timeline.open_candidate_session'), true);
...
assert.equal(google.messaging.lightweight_connector_message_types.includes('meeting_timeline.candidate_launch_plan'), false);
assert.equal(google.messaging.lightweight_connector_message_types.includes('meeting_timeline.open_candidate_session'), false);
...
assert.equal(google.messaging.background_message_types.includes('meeting_timeline.candidate_launch_plan'), false);
assert.equal(google.messaging.background_message_types.includes('meeting_timeline.open_candidate_session'), false);
...
assert.equal(google.messaging.examples.candidate_launch_plan.type, 'meeting_timeline.candidate_launch_plan');
assert.equal(google.messaging.examples.candidate_launch_plan.options.requireSpeakerTrack, true);
assert.equal(google.messaging.examples.open_candidate_session.type, 'meeting_timeline.open_candidate_session');
assert.equal(google.messaging.examples.open_candidate_session.options.requireSpeakerTrack, true);
...
assert.equal(matrix.bundles.find((row) => row.platform === 'microsoft_teams').browser.matches.includes('https://teams.live.com/*'), true);
