...
assert.equal(packageJson.scripts['meeting-app:adapter-handoff-package'], 'node scripts/meeting-app-adapter-handoff-package.mjs --platforms=google-meet,teams,zoom,webex,lark --base-url=http://localhost:8787 --out-dir=data/meeting-app-adapter-handoff-packages --report-file=data/meeting-app-adapter-handoff-package-report.json');
assert.equal(packageJson.scripts['meeting-app:adapter-verify'], 'node scripts/meeting-app-adapter-verify.mjs --platforms=google-meet,teams,zoom,webex,lark --package-dir=data/meeting-app-adapter-handoff-packages --evidence-dir=data/meeting-app-adapter-evidence --report-file=data/meeting-app-adapter-verification-report.json');
assert.equal(packageJson.scripts['meeting-app:adapter-capability'], 'node scripts/meeting-app-adapter-capability.mjs --platforms=google-meet,teams,zoom,webex,lark --report-file=data/meeting-app-adapter-capability-report.json');
assert.equal(packageJson.scripts['meeting-app:adapter-integration-package'], 'node scripts/meeting-app-adapter-integration-package.mjs --platforms=google-meet,teams,zoom,webex,lark --base-url=http://localhost:8787 --out-dir=data/meeting-app-adapter-integration-packages --report-file=data/meeting-app-adapter-integration-package-report.json');
...
assert.match(readme, /npm run meeting-app:adapter-handoff-package/);
assert.match(readme, /npm run meeting-app:adapter-verify/);
assert.match(readme, /npm run meeting-app:adapter-capability/);
assert.match(readme, /npm run meeting-app:adapter-integration-package/);
...
assert.match(readme, /data\/meeting-app-adapter-handoff-packages/);
assert.match(readme, /data\/meeting-app-adapter-handoff-package-report\.json/);
assert.match(readme, /data\/meeting-app-adapter-evidence/);
assert.match(readme, /data\/meeting-app-adapter-verification-report\.json/);
assert.match(readme, /data\/meeting-app-adapter-capability-report\.json/);
assert.match(readme, /data\/meeting-app-adapter-integration-packages/);
assert.match(readme, /data\/meeting-app-adapter-integration-package-report\.json/);
