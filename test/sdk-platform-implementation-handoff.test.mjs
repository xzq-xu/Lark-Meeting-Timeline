...
assert.equal(google.package_entrypoints.adapter_selection_module, '@ai-annotation/meeting-timeline-sdk/adapters/platform-adapter-selection');
...
assert.equal(google.contracts.adapter_selection_required_before_runtime_surface_install, true);
assert.equal(google.contracts.adapter_selection_timestamp_field, 'captured_at_ms');
...
assert.equal(google.implementation_flow.find((step) => step.id === 'select_adapter_path').required_before, 'install_surface_runtime_or_run_preflight');
...
assert.equal(google.acceptance.commands.adapter_selection.includes('meeting-platform:adapter-selection'), true);
...
assert.equal(google.readiness.adapter_selection_ready, true);
