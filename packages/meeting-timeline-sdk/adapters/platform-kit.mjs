...
export function buildMeetingPlatformKitReport(options = {}) {
  ...
  const platformAdapterInstallManifest = buildMeetingPlatformAdapterInstallManifest({
  ...
  return {
    ...
    platform_adapter_install_manifest: platformAdapterInstallManifest,
    platform_adapter_launch_plan: buildMeetingPlatformAdapterLaunchPlan(platformAdapterInstallManifest, options),
...
export function createMeetingPlatformTimelineKit(clientOrOptions, options = {}) {
  ...
  return {
    ...
    platformAdapterCandidatePreflight(input = {}, preflightOptions = {}) {
      return buildMeetingPlatformAdapterCandidatePreflight(input, withDefaults(defaults, preflightOptions));
    },
    ...
    platformConsumerHandoff(handoffOptions = {}) {
      return buildMeetingPlatformConsumerHandoff(withDefaults(defaults, handoffOptions));
    },
    ...
    platformAdapterAuthoringPlan(platform, authoringOptions = {}) {
      return buildMeetingPlatformAdapterAuthoringPlan(platform, withDefaults(defaults, authoringOptions));
    },
    ...
    platformAdapterExportPackage(platform, exportInput = {}, exportOptions = {}) {
      return buildMeetingPlatformAdapterExportPackage(platform, exportInput, withDefaults(defaults, exportOptions));
    },
    platformAdapterExportPackageMatrix(exportInput = {}, exportOptions = {}) {
      return buildMeetingPlatformAdapterExportPackageMatrix(exportInput, withDefaults(defaults, exportOptions));
    },
    platformAdapterImportPlan(exportPackage, importInput = {}, importOptions = {}) {
      return buildMeetingPlatformAdapterImportPlan(exportPackage, importInput, withDefaults(defaults, importOptions));
    },
    assertPlatformAdapterImportPlan(planOrPackage, importInput = {}, importOptions = {}) {
      return assertMeetingPlatformAdapterImportPlan(planOrPackage, importInput, withDefaults(defaults, importOptions));
    },
    ...
    meetingAppAdapterRuntimeConfig(specOrPlatform = {}, configOptions = {}) {
      return buildMeetingAppAdapterRuntimeConfig(specOrPlatform, withDefaults(defaults, configOptions));
    },
    meetingAppAdapterRuntimeConfigMatrix(configOptions = {}) {
      return buildMeetingAppAdapterRuntimeConfigMatrix(withDefaults(defaults, configOptions));
    },
    assertMeetingAppAdapterRuntimeConfig(configOrSpec = {}, configOptions = {}) {
      return assertMeetingAppAdapterRuntimeConfig(configOrSpec, withDefaults(defaults, configOptions));
    },
    ...
    meetingAppRuntimeAdapterHandoff(selectionOrInput = {}, handoffOptions = {}) {
      return buildMeetingAppRuntimeAdapterHandoff(selectionOrInput, withDefaults(defaults, handoffOptions));
    },
