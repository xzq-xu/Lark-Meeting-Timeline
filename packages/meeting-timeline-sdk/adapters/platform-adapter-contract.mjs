...
export function buildMeetingPlatformAdapterContract(platform, options = {}) {
  ...
  return compactObject({
    ...
    supported_surfaces: {
      ...
      primary: runtime.adapter_surfaces?.primary,
      recommended_order: runtime.adapter_surfaces?.recommended_order,
      provider_reconcile_surface: runtime.adapter_surfaces?.provider_reconcile_surface,
    },
...
export function buildMeetingPlatformAdapterContractMatrix(options = {}) {
  ...
  return {
    ...
    rows: contracts.map((contract) => ({
      ...
      mode: contract.mode,
      primary_surface: contract.adapter_surfaces?.primary,
      surface_order: contract.adapter_surfaces?.recommended_order,
      provider_reconcile_surface: contract.adapter_surfaces?.provider_reconcile_surface,
      ...
      pilot_provider_records_required: contract.evidence_thresholds?.pilot?.provider_records_required,
      production_provider_records_required: contract.evidence_thresholds?.production?.provider_records_required,
...
export function buildMeetingPlatformAdapterContractAcceptanceMatrix(options = {}) {
  ...
  return {
    ...
    rows: reports.map((report) => ({
      ...
      primary_surface: report.summary.primary_surface,
