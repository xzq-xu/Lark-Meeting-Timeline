...
import type {
  ...
  MeetingPlatformAdapterImportPlanOptions,
...
export interface MeetingPlatformTimelineKit {
  ...
  platformAdapterImportPlan(exportPackage: MeetingPlatformAdapterExportPackage | Record<string, unknown>, importInput?: MeetingPlatformAdapterImportPlanOptions, importOptions?: MeetingPlatformAdapterImportPlanOptions): MeetingPlatformAdapterImportPlan;
  assertPlatformAdapterImportPlan(planOrPackage: MeetingPlatformAdapterImportPlan | MeetingPlatformAdapterExportPackage | Record<string, unknown>, importInput?: MeetingPlatformAdapterImportPlanOptions, importOptions?: MeetingPlatformAdapterImportPlanOptions): MeetingPlatformAdapterImportPlan;
  ...
  platformAdapterSession(launchPlanOrInput?: MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterRuntimeTarget | Record<string, unknown>, clientOrSessionOptions?: MeetingPlatformAdapterSessionClient | MeetingPlatformAdapterSessionOptions, sessionOptions?: MeetingPlatformAdapterSessionOptions): MeetingPlatformAdapterSession;
  platformAdapterSessionHandoff(launchPlanOrInput?: MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterRuntimeTarget | Record<string, unknown>, handoffOptions?: MeetingPlatformAdapterSessionOptions): MeetingPlatformAdapterSessionHandoff;
  platformAdapterRunner(manifestOrInput?: MeetingPlatformAdapterInstallManifest | MeetingPlatformAdapterRuntimeManifest | MeetingPlatformAdapterRuntimeTarget | MeetingPlatformAdapterLaunchPlan | Record<string, unknown>, clientOrRunnerOptions?: MeetingPlatformAdapterSessionClient | MeetingPlatformAdapterRunnerOptions, runnerOptions?: MeetingPlatformAdapterRunnerOptions): MeetingPlatformAdapterRunner;
  openPlatformAdapterSession(manifestOrInput?: MeetingPlatformAdapterInstallManifest | MeetingPlatformAdapterRuntimeManifest | MeetingPlatformAdapterRuntimeTarget | MeetingPlatformAdapterLaunchPlan | Record<string, unknown>, launchInput?: MeetingPlatformAdapterLaunchPlanOptions | MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterRuntimeTarget | string | URL | Record<string, unknown>, openOptions?: MeetingPlatformAdapterRunnerOptions): Promise<MeetingPlatformAdapterOpenSessionEvent>;
  platformAdapterRunnerHandoff(manifestOrInput?: MeetingPlatformAdapterInstallManifest | MeetingPlatformAdapterRuntimeManifest | MeetingPlatformAdapterRuntimeTarget | MeetingPlatformAdapterLaunchPlan | Record<string, unknown>, handoffOptions?: MeetingPlatformAdapterRunnerOptions): MeetingPlatformAdapterRunnerHandoff;
  platformAdapterMessageBridge(manifestOrRunner?: MeetingPlatformAdapterInstallManifest | MeetingPlatformAdapterRuntimeManifest | MeetingPlatformAdapterRuntimeTarget | MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterRunner | Record<string, unknown>, clientOrBridgeOptions?: MeetingPlatformAdapterSessionClient | MeetingPlatformAdapterMessageBridgeOptions, bridgeOptions?: MeetingPlatformAdapterMessageBridgeOptions): MeetingPlatformAdapterMessageBridge;
  platformAdapterMessageBridgeHandoff(manifestOrInput?: MeetingPlatformAdapterInstallManifest | MeetingPlatformAdapterRuntimeManifest | MeetingPlatformAdapterRuntimeTarget | MeetingPlatformAdapterLaunchPlan | Record<string, unknown>, handoffOptions?: MeetingPlatformAdapterMessageBridgeOptions): MeetingPlatformAdapterMessageBridgeHandoff;
