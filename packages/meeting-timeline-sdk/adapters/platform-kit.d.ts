...
export interface MeetingPlatformTimelineKit {
  ...
  platformAdapterSession(launchPlanOrInput?: MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterCandidateLaunchPlan | MeetingPlatformAdapterRuntimeTarget | Record<string, unknown>, clientOrSessionOptions?: MeetingPlatformAdapterSessionClient | MeetingPlatformAdapterSessionOptions, sessionOptions?: MeetingPlatformAdapterSessionOptions): MeetingPlatformAdapterSession;
  platformAdapterSessionHandoff(launchPlanOrInput?: MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterCandidateLaunchPlan | MeetingPlatformAdapterRuntimeTarget | Record<string, unknown>, handoffOptions?: MeetingPlatformAdapterSessionOptions): MeetingPlatformAdapterSessionHandoff;
  platformAdapterRunner(manifestOrInput?: MeetingPlatformAdapterInstallManifest | MeetingPlatformAdapterRuntimeManifest | MeetingPlatformAdapterRuntimeTarget | MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterCandidateLaunchPlan | Record<string, unknown>, clientOrRunnerOptions?: MeetingPlatformAdapterSessionClient | MeetingPlatformAdapterRunnerOptions, runnerOptions?: MeetingPlatformAdapterRunnerOptions): MeetingPlatformAdapterRunner;
  openPlatformAdapterSession(manifestOrInput?: MeetingPlatformAdapterInstallManifest | MeetingPlatformAdapterRuntimeManifest | MeetingPlatformAdapterRuntimeTarget | MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterCandidateLaunchPlan | Record<string, unknown>, launchInput?: MeetingPlatformAdapterLaunchPlanOptions | MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterCandidateLaunchPlan | MeetingPlatformAdapterRuntimeTarget | string | URL | Record<string, unknown>, openOptions?: MeetingPlatformAdapterRunnerOptions): Promise<MeetingPlatformAdapterOpenSessionEvent>;
  platformAdapterRunnerHandoff(manifestOrInput?: MeetingPlatformAdapterInstallManifest | MeetingPlatformAdapterRuntimeManifest | MeetingPlatformAdapterRuntimeTarget | MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterCandidateLaunchPlan | Record<string, unknown>, handoffOptions?: MeetingPlatformAdapterRunnerOptions): MeetingPlatformAdapterRunnerHandoff;
  platformAdapterMessageBridge(manifestOrRunner?: MeetingPlatformAdapterInstallManifest | MeetingPlatformAdapterRuntimeManifest | MeetingPlatformAdapterRuntimeTarget | MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterCandidateLaunchPlan | MeetingPlatformAdapterRunner | Record<string, unknown>, clientOrBridgeOptions?: MeetingPlatformAdapterSessionClient | MeetingPlatformAdapterMessageBridgeOptions, bridgeOptions?: MeetingPlatformAdapterMessageBridgeOptions): MeetingPlatformAdapterMessageBridge;
  platformAdapterMessageBridgeHandoff(manifestOrInput?: MeetingPlatformAdapterInstallManifest | MeetingPlatformAdapterRuntimeManifest | MeetingPlatformAdapterRuntimeTarget | MeetingPlatformAdapterLaunchPlan | MeetingPlatformAdapterCandidateLaunchPlan | Record<string, unknown>, handoffOptions?: MeetingPlatformAdapterMessageBridgeOptions): MeetingPlatformAdapterMessageBridgeHandoff;
