...
export function buildMeetingAppExtensionContentScriptSource(options = {}) {
  ...
  return [
    ...
    '}',
    '',
    'function bindLifecycleEndCapture(bridge) {',
    '  let sent = false;',
    ...
    '      captured_at_ms: capturedAtMs,',
    '      detector_source: "meeting_app_extension_pagehide",',
    '      observer_surface: "browser_extension",',
    '      suppress_auto_annotations: true,',
    '      meeting_app_record: lifecycleEndedEvidenceRecord(meeting, event.type || "pagehide", capturedAtMs),',
    '    }).catch(() => {});',
    '  };',
    ...
    'globalThis.__meetingTimelineLifecycleEndCapture = bindLifecycleEndCapture(bridge);',
