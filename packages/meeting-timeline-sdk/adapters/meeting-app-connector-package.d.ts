...
export interface MeetingAppTimelineConnectorHostWiringGuideRow {
  platform: string;
  display_name?: string;
  accepted: boolean;
  selected_surface?: string;
  ...
  install_step?: string;
  config_file?: string;
  runtime_client?: Record<string, unknown>;
  host_install?: Record<string, unknown>;
  runtime_sequence?: Array<Record<string, unknown>>;
  onboarding_step_ids?: string[];
  code_snippet?: string;
  validation_files?: string[];
  issue_count: number;
  issues: string[];
...
export interface MeetingAppTimelineConnectorHostWiringGuide {
  type: 'meeting_app_timeline_connector_host_wiring_guide';
  schema: 'meeting_app_timeline_connector_host_wiring_guide';
  schema_version: 1;
  accepted: boolean;
  package_id?: string;
  ...
  rows: MeetingAppTimelineConnectorHostWiringGuideRow[];
  issue_count: number;
  issues: string[];
  next_actions: string[];
}

export interface MeetingAppTimelineConnectorHostWiringGuideAcceptanceReport {
  type: 'meeting_app_timeline_connector_host_wiring_guide_acceptance_report';
  schema: 'meeting_app_timeline_connector_host_wiring_guide_acceptance_report';
  schema_version: 1;
  accepted: boolean;
  package_id?: string;
  platform_count: number;
...
export interface MeetingAppTimelineHostAdapterConfig {
  ...
  realtime_contract: {
    ...
    mark_timestamp_field?: string;
    provider_reconcile_blocks_realtime?: boolean;
    transcript_blocks_realtime?: boolean;
    provider_replay_blocks_realtime?: boolean;
    can_start_axis_before_provider?: boolean;
    can_insert_annotation_on_current_axis?: boolean;
  };
  input_sources: Array<Record<string, unknown>>;
...
export interface MeetingAppTimelineHostAdapterConfigIndex {
...
export interface MeetingAppTimelineHostAdapterBootstrapPlan {
  type: 'meeting_app_timeline_host_adapter_bootstrap_plan';
  schema: 'meeting_app_timeline_host_adapter_bootstrap_plan';
  schema_version: 1;
  accepted: boolean;
  package_id?: string;
  platform?: string;
  ...
  resolution: import('./meeting-platform-connector.mjs').MeetingPlatformConnectorResolution;
  host_config?: MeetingAppTimelineHostAdapterConfig;
  local_axis_contract: Record<string, unknown>;
  startup_order: string[];
  steps: Array<Record<string, unknown> & {
    id: string;
    order: number;
  ...
  optional_runtime_actions: string[];
  bridge_contract?: Record<string, unknown>;
  sdk_facade_methods: Record<string, string | undefined>;
  issue_count: number;
  issues: string[];
  next_actions: string[];
}
...
export function buildMeetingAppTimelineHostAdapterConfig(
  matrixOrChecklistOrPackage?: MeetingAppTimelineConnectorAdapterMatrix | MeetingAppTimelineConnectorHostInstallChecklist | MeetingAppTimelineConnectorPackage | MeetingAppTimelineHostAdapterConfig | Record<string, unknown>,
  platformOrOptions?: string | Record<string, unknown>,
  options?: Record<string, unknown>,
): MeetingAppTimelineHostAdapterConfig;

export function buildMeetingAppTimelineHostAdapterConfigIndex(
  matrixOrChecklistOrPackage?: MeetingAppTimelineConnectorAdapterMatrix | MeetingAppTimelineConnectorHostInstallChecklist | MeetingAppTimelineConnectorPackage | Record<string, unknown>,
  options?: Record<string, unknown>,
): MeetingAppTimelineHostAdapterConfigIndex;

export function assertMeetingAppTimelineHostAdapterConfig(
  matrixOrConfigOrChecklistOrPackage?: MeetingAppTimelineConnectorAdapterMatrix | MeetingAppTimelineConnectorHostInstallChecklist | MeetingAppTimelineConnectorPackage | MeetingAppTimelineHostAdapterConfig | Record<string, unknown>,
  platformOrOptions?: string | Record<string, unknown>,
  options?: Record<string, unknown>,
): MeetingAppTimelineHostAdapterConfig;

export function assertMeetingAppTimelineHostAdapterConfigIndex(
...
export function buildMeetingAppTimelineConnectorHostWiringGuide(
  matrixOrChecklistOrPackage?: MeetingAppTimelineConnectorHostWiringGuide | MeetingAppTimelineConnectorAdapterMatrix | MeetingAppTimelineConnectorHostInstallChecklist | MeetingAppTimelineConnectorPackage | Record<string, unknown>,
  options?: Record<string, unknown>,
): MeetingAppTimelineConnectorHostWiringGuide;

export function buildMeetingAppTimelineConnectorHostWiringGuideAcceptanceReport(
  guideOrMatrixOrChecklistOrPackage?: MeetingAppTimelineConnectorHostWiringGuide | MeetingAppTimelineConnectorAdapterMatrix | MeetingAppTimelineConnectorHostInstallChecklist | MeetingAppTimelineConnectorPackage | Record<string, unknown>,
  options?: Record<string, unknown>,
): MeetingAppTimelineConnectorHostWiringGuideAcceptanceReport;

export function assertMeetingAppTimelineConnectorHostWiringGuide(
  guideOrMatrixOrChecklistOrPackage?: MeetingAppTimelineConnectorHostWiringGuide | MeetingAppTimelineConnectorAdapterMatrix | MeetingAppTimelineConnectorHostInstallChecklist | MeetingAppTimelineConnectorPackage | Record<string, unknown>,
  options?: Record<string, unknown>,
): MeetingAppTimelineConnectorHostWiringGuide;
...
export function buildMeetingAppTimelineHostAdapterBootstrapPlan(
  indexOrMatrixOrChecklistOrPackage?: MeetingAppTimelineHostAdapterConfigResolution | MeetingAppTimelineHostAdapterConfigIndex | MeetingAppTimelineConnectorAdapterMatrix | MeetingAppTimelineConnectorHostInstallChecklist | MeetingAppTimelineConnectorPackage | Record<string, unknown>,
  input?: string | URL | Record<string, unknown>,
  options?: Record<string, unknown>,
): MeetingAppTimelineHostAdapterBootstrapPlan;

export function assertMeetingAppTimelineHostAdapterBootstrapPlan(
  indexOrMatrixOrChecklistOrPackage?: MeetingAppTimelineHostAdapterConfigResolution | MeetingAppTimelineHostAdapterConfigIndex | MeetingAppTimelineConnectorAdapterMatrix | MeetingAppTimelineConnectorHostInstallChecklist | MeetingAppTimelineConnectorPackage | Record<string, unknown>,
  input?: string | URL | Record<string, unknown>,
  options?: Record<string, unknown>,
): MeetingAppTimelineHostAdapterBootstrapPlan;
