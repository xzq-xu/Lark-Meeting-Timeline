...
export async function buildMeetingPlatformAdapterInstallManifestCliReport(options = {}) {
  ...
  const report = {
    ...
    raw_signal_validation_platform_count: manifest.raw_signal_validation?.platform_count ?? 0,
    raw_signal_validation_ready_count: manifest.raw_signal_validation?.ready_count ?? 0,
