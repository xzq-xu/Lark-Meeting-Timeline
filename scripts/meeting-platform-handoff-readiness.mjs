...
function summarizeRow(row = {}, loaded) {
  return {
    ...
    adapter_route_ready: row.adapter_route_ready,
    adapter_first_route: row.adapter_first_route,
    adapter_route_issue_codes: row.adapter_route_issue_codes ?? [],
...
async function buildReport() {
  ...
  return {
    ...
    adapter_route_ready_count: matrix.adapter_route_ready_count,
